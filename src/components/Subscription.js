    ...
    return (
      ...
      <div className="box has-background-grey-lighter">
        <div className="media">
          ...
          <div className="media-content is-clipped is-hidden-mobile">
          ...
          <div className="media-content is-clipped is-hidden-tablet">
            <div className="columns is-flex-mobile">
              <div className="column has-text-left">
                <h1 className="title is-size-3-mobile">{this.props.sub.name}</h1>
                <h2 className="subtitle has-text-weight-light is-size-5-mobile">£{this.props.sub.cost} {this.props.sub.paymentDate.fromNow()}</h2>
              </div>
            </div>
          </div>
